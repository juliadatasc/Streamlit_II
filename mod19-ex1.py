...
def main():
    st.set_page_config(
        ...
        page_icon=r"C:\Users\angel\Downloads\Curso Ciência de Dados\Módulo_19_-_Streamlit_II\Exercício_1\img\telmarketing_icon.png",
        layout="wide",
        initial_sidebar_state="expanded",
    )

    # SIDEBAR
    image = Image.open(fp=r"C:\Users\angel\Downloads\Curso Ciência de Dados\Módulo_19_-_Streamlit_II\Exercício_1\img\Bank-Branding.jpg")
    ...
    bank_raw = load_data(
        file_data=r"C:\Users\angel\Downloads\Curso Ciência de Dados\Módulo_19_-_Streamlit_II\Exercício_1\data-input\bank-additional-full.csv", sep=';')
    bank = bank_raw.copy()
